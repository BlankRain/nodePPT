...
var idSelectReg=new RegExp('\\#' + v);
var classSelectReg=new RegExp('\\.' + v);
var ParseEngine={
  slideToken:splitReg,
  noteToken:noteReg,
    ...
    attrs.forEach(function (attr) {
        if (!!~attr.indexOf('=')) {
            ...
            ids.forEach(function (v) {
                if (v !== '') {
                    ParseEngine.idToken.test(idinput) && idArr.push(v);
                    ParseEngine.classToken.test(idinput) && classArr.push(v);
                }
            });
        }
    });
